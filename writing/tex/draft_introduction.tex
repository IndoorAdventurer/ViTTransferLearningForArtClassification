...
More formally, the following research question is proposed: \quote{\textit{To what extent (and in what manners) does utilizing TL allow ViTs to perform on par with CNNs for material classification of artworks, when compute resources are limited to a single GPU/TPU?}}
