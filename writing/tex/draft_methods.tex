...
% TODO if you do end up using distilation with ConvNext as a teacher: don't forget to change this section!!! TODO 2: im not completely happy with the part about DeiT. Doesn't flow super nicely
